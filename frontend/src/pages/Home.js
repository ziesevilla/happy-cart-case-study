...
// ... (Keep PROMOS, HERO_SLIDES, FEATURED_GRID, CATEGORIES constants exactly as they were) ...
const PROMOS = [
...
const Home = () => {
    ...
    // --- LOGIC: Filter 5-Star & Sort by Likes ---
    const topReviews = reviews
        .filter(r => r.rating === 5) 
        .sort((a, b) => (b.likes || 0) - (a.likes || 0)) // Descending Order by Likes
    ...
    return (
        <div className="home-page animate-fade-in">
                    ...
                    <div className="category-marquee-wrapper w-100 m-0">
                        <div className="category-track">
                            {[...CATEGORIES, ...CATEGORIES, ...CATEGORIES].map((cat, idx) => (
                                <div key={idx} className="category-card d-flex align-items-center justify-content-center position-relative" style={{ '--cat-img': `url(${cat.img})` }}>
            ...
            {/* SECTION 5: CUSTOMER REVIEWS (REAL DATA + LIKES) */}
            <div className="w-100 m-0 bg-white py-5">
                    ...
                    <Row className="g-4 px-4 mx-0 justify-content-center"> 
                        {topReviews.length > 0 ? topReviews.map((review) => {
                                        ...
                                        <div className="d-flex align-items-center justify-content-center gap-3 mb-3">
                                            ...
                                            <div className="text-start">
                                                ...
                                                <small className="text-muted" style={{fontSize: '0.7rem'}}>
                                                    Verified Buyer • {review.productName || 'View Item'}
                                                </small>
                                            </div>
                                        </div>
                            ...
                            <div className="text-center text-muted py-5">
                                <p>No 5-star reviews yet. Be the first!</p>
                            </div>
                        )}
                    </Row>
                </Container>
